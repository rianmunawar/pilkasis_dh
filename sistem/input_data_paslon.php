  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div id="page-inner">
        <div class="row">
          <div class="col-lg-12">
            <h2><i class="fa fa-user"> Upload data paslon</i></h2>
          </div>
        </div>
        <!-- /. ROW  -->
          ...
          <div class="col-lg-6">
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label>NISN Calon Ketua OSIS</label>
                <input type="text" name="NISN_ketua" required="required" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>NISN wakil</label>
                <input type="text" name="NISN_wakil" required="required" class="form-control">
              </div>
              <div class="form-group">
