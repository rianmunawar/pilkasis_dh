...
INSERT INTO `tbl_akses` (`NISN`, `kode_akses`, `level`) VALUES
('16', 'RTYUI', 'admin');
...
INSERT INTO `tbl_dpt` (`NISN`, `nama_siswa`, `status`, `waktu`) VALUES
('16', 'Rian Munawar', 'Belum memilih', '-');
